...
import 'package:cadastramento_pontos_turisticos/pages/detalhesPontos.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../dao/pontosturisticosDao.dart';
import '../model/pontosTuristicos.dart';
import 'conteudoFormDialog.dart';
import 'filtroPage.dart';
...
class _ListaPontosTuristicosPageState extends State<ListaPontosTuristicosPage>{
  ...
  Widget _criarBody(){
    ...
    if(_pontos.isEmpty){
      return const Center(
        child: Text('Nenhum pontocadastrado',
